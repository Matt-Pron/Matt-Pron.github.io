...
class Entities {
    ...
    getValidSpawnPos(isPlayer = false, safeDist = 18) {
        ...
        do {
            ...
            if(this.map[ry][rx] !== 1) continue;
            if(this.entities.some(e => e.x === rx && e.y === ry)) continue;

            const p = this.entities.find(e => e instanceof Player) || false;
    ...
    // populateMap(map, entities, clericPos) {
